...
#include <Windows.h>
#include <winternl.h>
// NtQuerySystemInformation related data structure
// Note: On MinGW, winternl.h already provides KWAIT_REASON / SYSTEM_THREADS,
// so skip the duplicate definitions to avoid "multiple definition" errors.
#ifndef __MINGW32__
